...
/**
 * Viewer download route. Mounted at `/download` by index.tsx.
 *
 ...
 *   7. loadPhotoPreview    — absent -> 404; failure -> 500.
 *   8. buildDownloadFilename + privateDownloadResponse -> 200 attachment.
 *
 * No R2 keys, bucket names, album IDs, photo IDs, or exception details are ever
 * logged or echoed. Only generated, metadata-stripped preview JPEGs are served.
 */
